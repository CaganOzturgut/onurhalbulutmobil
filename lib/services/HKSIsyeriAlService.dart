...
class HKSIsYeriAlService {
  final _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/hks/ureticiisyeri');

  Future<HKSIsyeriResponseDto> getHKSIsyeri (HKSIsyeriRequestDto hksisyeri) async {

    var cache = hksisyeri;

    var data = Crypt().encryptString(jsonEncode(hksisyeri));
    ...
    if (response.statusCode == 200) {
      ...
      HKSIsyeriResponseDto hksisyeriList =
      HKSIsyeriResponseDto.fromJson(json.decode(gelen));
      print(hksisyeriList);
      return hksisyeriList;

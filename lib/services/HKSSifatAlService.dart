...
class HKSSifatAlService {
  final _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/hks/ureticisifat');

  Future<HKSCariSifatResponseDto> getHKSSifat (HKSCariSifatRequestDto hkssifat) async {

    var cache = hkssifat;

    var data = Crypt().encryptString(jsonEncode(hkssifat));
    ...
    if (response.statusCode == 200) {
      ...
      HKSCariSifatResponseDto hksSifatList =
      HKSCariSifatResponseDto.fromJson(json.decode(gelen));
      print(hksSifatList);
      return hksSifatList;

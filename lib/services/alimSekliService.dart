...
class AlimSekliListService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/alimsekli');

  Future<AlimSekliResponseDto> getAlimSekli (AlimSekliRequestDto alimSekli) async {

    var cache = alimSekli;

    var data = Crypt().encryptString(jsonEncode(alimSekli));
    ...
    if (response.statusCode == 200) {
      ...
      AlimSekliResponseDto alimSekliList =
      AlimSekliResponseDto.fromJson(json.decode(gelen));
      print(alimSekliList);
      return alimSekliList;

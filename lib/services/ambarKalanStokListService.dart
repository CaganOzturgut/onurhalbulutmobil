...
class AmbarKalanStokListService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/ambarkalan');

  Future<AmbarKalanResponseDto> getAmbarKalanStokList (AmbarKalanRequestDto ambarKalan) async {

    var cache = ambarKalan;

    var data = Crypt().encryptString(jsonEncode(ambarKalan));
    ...
    if (response.statusCode == 200) {
      ...
      AmbarKalanResponseDto stokList =
      AmbarKalanResponseDto.fromJson(json.decode(gelen));
      print(stokList);
      return stokList;

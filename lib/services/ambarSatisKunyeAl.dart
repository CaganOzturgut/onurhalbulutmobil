...
class AmbarSatisKunyeAlService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/ambarsatis/kunyeal');

  Future<AmbarSatisEditResponseDto> getKunyeAl (AmbarSatisEditRequestDto ambar) async {
    ...
    if (response.statusCode == 200) {
      ...
      AmbarSatisEditResponseDto kunyeGelen =
      AmbarSatisEditResponseDto.fromJson(json.decode(gelen));
      print(kunyeGelen);
      return kunyeGelen;

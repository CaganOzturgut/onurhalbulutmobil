...
class AmbarSatisListService {
  final _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/ambarsatis/list');

  Future<AmbarSatisListResponseDto> getAmbarSatisList (AmbarSatisListRequestDto ambarsatis) async {

    var cache = ambarsatis;

    var data = Crypt().encryptString(jsonEncode(ambarsatis));
    ...
    if (response.statusCode == 200) {
      ...
      AmbarSatisListResponseDto ambarSatisList =
      AmbarSatisListResponseDto.fromJson(json.decode(gelen));
      print(ambarSatisList);
      return ambarSatisList;

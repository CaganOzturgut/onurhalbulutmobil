...
class BeldeListService {
  final _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/belde');

  Future<BeldeListResponseDto> getBeldeList (BeldeListRequestDto belde) async {

    var cache = belde;

    var data = Crypt().encryptString(jsonEncode(belde));
    ...
    if (response.statusCode == 200) {
      ...
      BeldeListResponseDto beldeList =
      BeldeListResponseDto.fromJson(json.decode(gelen));
      print(beldeList);
      return beldeList;

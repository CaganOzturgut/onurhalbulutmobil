...
class BuroListService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/buro');

  Future<BuroListResponseDto> getBuroList (BuroListRequestDto buro) async {

    var cache = buro;

    var data = Crypt().encryptString(jsonEncode(buro));
    ...
    if (response.statusCode == 200) {
      ...
      BuroListResponseDto buroList =
      BuroListResponseDto.fromJson(json.decode(gelen));
      print(buroList);
      return buroList;

...
class CariKartEditService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/carikart/edit');

  Future<CariKartEditResponseDto> getCariKartEdit (CariKartEditRequestDto edit) async {

    var loginData = edit;

    var aa = Crypt().encryptString(jsonEncode(edit));
    ...
    if (response.statusCode == 200) {
      ...
      CariKartEditResponseDto listeler =
      CariKartEditResponseDto.fromJson(json.decode(gelen));
      print(listeler);
      return listeler;

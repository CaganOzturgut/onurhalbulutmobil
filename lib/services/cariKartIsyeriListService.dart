...
import 'package:onurhalbulutmobil/dto/cariKartIsyeriListResponseDto.dart';
...
class CariKartIsyeriListService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/carikartisyeri');

  Future<CariKartIsyeriListResponseDto> getCariKartIsyeriList (CariKartIsyeriListRequestDto cariIsyeri) async {

    var cache = cariIsyeri;

    var data = Crypt().encryptString(jsonEncode(cariIsyeri));
    ...
    if (response.statusCode == 200) {
      ...
      CariKartIsyeriListResponseDto cariKartIsyeriList =
      CariKartIsyeriListResponseDto.fromJson(json.decode(gelen));
      print(cariKartIsyeriList);
      return cariKartIsyeriList;

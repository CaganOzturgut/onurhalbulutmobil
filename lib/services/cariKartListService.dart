...
class CariKartListeService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/carikart/list');

  Future<CariKartListResponseDto> getCariKartList(CariKartListRequestDto cariKartList) async {

    var loginData = cariKartList;

    var aa = Crypt().encryptString(jsonEncode(cariKartList));
    ...
    if (response.statusCode == 200) {
      ...
      CariKartListResponseDto listeler =
      CariKartListResponseDto.fromJson(json.decode(gelen));
      print(listeler);
      return listeler;

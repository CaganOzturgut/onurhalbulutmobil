...
class CariKartSaveService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/carikart/save');

  Future<CariKartSaveResponseDto> getCariKartSave (CariKartSaveRequestDto save) async {

    var loginData = save;

    var aa = Crypt().encryptString(jsonEncode(save));
    ...
    if (response.statusCode == 200) {
      ...
      CariKartSaveResponseDto sonuc = CariKartSaveResponseDto.fromJson(json.decode(gelen));

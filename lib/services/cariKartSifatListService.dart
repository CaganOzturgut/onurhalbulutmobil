...
class CariKartSifatListService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/carikartsifat');

  Future<CariKartSifatListResponseDto> getCariKartSifatList (CariKartSifatListRequestDto cariSifat) async {

    var cache = cariSifat;

    var data = Crypt().encryptString(jsonEncode(cariSifat));
    ...
    if (response.statusCode == 200) {
      ...
      CariKartSifatListResponseDto cariKartSifatList =
      CariKartSifatListResponseDto.fromJson(json.decode(gelen));
      print(cariKartSifatList);
      return cariKartSifatList;

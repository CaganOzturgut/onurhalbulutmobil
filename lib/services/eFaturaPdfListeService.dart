...
class EFaturaPdfListeService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/efatura/pdf');

  Future<EFaturaPdfResponseDto> getEFaturaPdf (EFaturaPdfRequestDto efatura) async {

    var cache = efatura;

    var data = Crypt().encryptString(jsonEncode(efatura));
    ...
    if (response.statusCode == 200) {
      ...
      EFaturaPdfResponseDto eFaturaPdfList =
      EFaturaPdfResponseDto.fromJson(json.decode(gelen));
      print(eFaturaPdfList);
      return eFaturaPdfList;

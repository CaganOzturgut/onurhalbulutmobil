...
class FaturaTuruListService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/satisfaturatur');

  Future<FaturaTurListResponseDto> getFaturaTuruList (FaturaTurListRequestDto faturaTuru) async {

    var cache = faturaTuru;

    var data = Crypt().encryptString(jsonEncode(faturaTuru));
    ...
    if (response.statusCode == 200) {
      ...
      FaturaTurListResponseDto faturaTurList =
      FaturaTurListResponseDto.fromJson(json.decode(gelen));
      print(faturaTurList);
      return faturaTurList;

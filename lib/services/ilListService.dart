...
class IlListService {
  final _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/il');

  Future<IlResponseDto> getIlList (IlRequestDto il) async {

    var cache = il;

    var data = Crypt().encryptString(jsonEncode(il));
    ...
    if (response.statusCode == 200) {
      ...
      IlResponseDto ilList =
      IlResponseDto.fromJson(json.decode(gelen));
      print(ilList);
      return ilList;

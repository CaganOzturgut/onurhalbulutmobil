...
class IlceListService {
  final _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/ilce');

  Future<IlceListResponseDto> getIlceList (IlceListRequestDto ilce) async {

    var cache = ilce;

    var data = Crypt().encryptString(jsonEncode(ilce));
    ...
    if (response.statusCode == 200) {
      ...
      IlceListResponseDto ilceList =
      IlceListResponseDto.fromJson(json.decode(gelen));
      print(ilceList);
      return ilceList;

...
class SoforListService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/sofor');

  Future<SoforListResponseDto> getSoforList (SoforListRequestDto sofor) async {

    var cache = sofor;

    var data = Crypt().encryptString(jsonEncode(sofor));
    ...
    if (response.statusCode == 200) {
      ...
      SoforListResponseDto soforList =
      SoforListResponseDto.fromJson(json.decode(gelen));
      print(soforList);
      return soforList;

...
class StokKartListService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/stokkart');

  Future<StokKartResponseDto> getStokKartList (StokKartRequestDto stok) async {

    var cache = stok;

    var data = Crypt().encryptString(jsonEncode(stok));
    ...
    if (response.statusCode == 200) {
      ...
      StokKartResponseDto stokList =
      StokKartResponseDto.fromJson(json.decode(gelen));
      print(stokList);
      return stokList;

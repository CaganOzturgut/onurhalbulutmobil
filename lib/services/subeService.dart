...
class SubeService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lisans/getsube');

  Future<SubeResponseDto> getSube(SubeRequestDto sube) async {

    var loginData = sube;

    var aa = Crypt().encryptString(jsonEncode(sube));
    ...
    if (response.statusCode == 200) {
      ...
      SubeResponseDto subeler =
      SubeResponseDto.fromJson(json.decode(gelen));
      print(subeler);
      return subeler;

...
class UrunNiteliktListService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/urunnitelik');

  Future<UrunNitelikResponseDto> getUrunNitelikList (UrunNitelikRequestDto nitelik) async {

    var cache = nitelik;

    var data = Crypt().encryptString(jsonEncode(nitelik));
    ...
    if (response.statusCode == 200) {
      ...
      UrunNitelikResponseDto nitelikList =
      UrunNitelikResponseDto.fromJson(json.decode(gelen));
      print(nitelikList);
      return nitelikList;

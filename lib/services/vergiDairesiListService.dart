...
class VergiDairesiListService {
  var _url = Uri.http(OnurHalBulutAppSetting.TestUrl,'api/lookup/vergidairesi');

  Future<VergiDairesiListResponseDto> getVergiDairesiList (VergiDairesiListRequestDto vergiDairesi) async {

    var cache = vergiDairesi;

    var data = Crypt().encryptString(jsonEncode(vergiDairesi));
    ...
    if (response.statusCode == 200) {
      ...
      VergiDairesiListResponseDto vergiList =
      VergiDairesiListResponseDto.fromJson(json.decode(gelen));
      print(vergiList);
      return vergiList;
